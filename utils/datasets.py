...
class LoadRealSense2:  # Stream from Intel RealSense D435
    ...
    def __init__(self, width='640', height='480', fps='30'):
        ...
        self.cfg.enable_stream(rs.stream.depth, 0, self.width, self.height, rs.format.z16, self.fps)
        self.cfg.enable_stream(rs.stream.color, 0, self.width, self.height, rs.format.bgr8, self.fps)

        # self.cfg.enable_stream(rs.stream.color, 0, self.width, self.height, rs.format.rgb8, self.fps)
